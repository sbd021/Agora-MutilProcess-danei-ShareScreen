...
ENGLISH_API LPCTSTR IDS_CHN_ROLE0 = _T("Teacher");
ENGLISH_API LPCTSTR IDS_CHN_ROLE1 = _T("Student");
ENGLISH_API LPCTSTR IDS_CHN_ROLE2 = _T("DS_BROADCASTER");
ENGLISH_API LPCTSTR IDS_CHN_ROLE3 = _T("DS_AUDIENCE");

ENGLISH_API LPCTSTR IDS_CHN_CASTER = _T("Teacher");
ENGLISH_API LPCTSTR IDS_CHN_AUDIENCE = _T("Student");
